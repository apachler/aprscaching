...
await p.goto("http://127.0.0.1:4184/#12/47.07/15.44", { waitUntil:"load" });
...
await p.screenshot({ path: new URL("./out/18-dark.png", import.meta.url).pathname });
console.log("18-dark done");
await b.close();
