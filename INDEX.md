...
The APRScaching-first web workbench, by OE8APR. This file is a map of the repository.

## Start here
- `README.md` — what the project is and how to run it (pnpm install, wrangler, ingest)
- `docs/` — the product manual (also served in-app): caching, the workbench, operating an instance, the API
