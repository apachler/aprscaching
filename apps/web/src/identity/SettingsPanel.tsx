...
export function SettingsPanel(props: {
  ...
  async function deleteData() {
    if (
      !confirm(
        `Permanently erase ${props.callsign}? Your finds are anonymised and your account, keys and personal data are deleted. This cannot be undone.`,
      )
    )
      return;
    setGdpr("Erasing…");
      ...
      {match("About credits attribution Bruninga WB4APR APRS trademark licence open source") && (
        <Group title="About & credits" defaultOpen={false}>
          ...
          <p className="muted">
            ...
            (1948–2022). “APRS” is his trademark. This is an independent, unofficial implementation built from open
            specifications (APRS101, APRS-IS) and is not affiliated with, sponsored by, or endorsed by him or his
            estate.
          </p>
          <p className="muted">
            Maps © OpenStreetMap contributors, rendered with MapLibre. Built on open source; the APRScaching game and
            this app are the author’s own work.
          </p>
          <SourceLink />
        </Group>
      )}
