...
/**
 * fieldStation.ts — the off-grid "field station" client store. A radio + browser is a
 ...
 * returns. Pure classification lives in `@aprscaching/aprs` (`localEvent`); this is just the bounded store.
 */
import { localEvent, type LocalStation, type LocalMessage } from "@aprscaching/aprs";
