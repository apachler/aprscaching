...
interface GridPalette { bg: string; line: string; minorOp: number; majorOp: number; minorW: number; majorW: number; glow?: number }
  ...
  return {
    ...
    layers: [
      ...
      { id: "grid-major", type: "line", source: "grid_major",
        paint: { "line-color": pal.line, "line-opacity": pal.majorOp, "line-width": pal.majorW, "line-blur": pal.glow ?? 0 } },
    ],
...
/** The Cogmind map (docs/24 §4.2): near-black phosphor field + a dim green grid, glowing on the whole
