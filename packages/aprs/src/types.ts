...
export interface DecodedWeather {
  tempC?: number; windDirDeg?: number; windKn?: number; gustKn?: number;
  humidity?: number; pressureHpa?: number; rain1hMm?: number; rain24hMm?: number; rainMidnightMm?: number;
}
export interface DecodedTelemetry { seq?: number; analog: number[]; digital: boolean[] }
export interface DecodedMessage {
  addressee: string; text: string; msgNo?: string;
  ack?: boolean; rej?: boolean; bulletin?: string;
}
