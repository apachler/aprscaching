...
describe("third-party encapsulation (path A P3)", () => {
  it("wraps the user's info under the peer's login with a leading }", () => {
    const line = thirdPartyEncap({
      gateCall: "OE8APR-10",
      userCall: "OE3ABC-7",
      info: ":OE1XYZ   :hi{1",
      dst: "APAC01",
...
describe("field-station local events", () => {
