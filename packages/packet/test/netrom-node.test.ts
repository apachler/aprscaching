...
describe("NET/ROM node routing engine", () => {
  ...
  it("keeps the higher-quality route and finds by alias", () => {
    ...
    node.consume(
      bcastFrom("N1", [{ dest: A("OE3FAR"), alias: "FAR", neighbor: A("OE1N1"), quality: 100 }]),
      A("OE1N1"),
    );
    node.consume(
      bcastFrom("N2", [{ dest: A("OE3FAR"), alias: "FAR", neighbor: A("OE2N2"), quality: 250 }]),
      A("OE2N2"),
    );
