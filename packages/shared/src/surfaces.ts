 ...
 *
 * The app is a single-page map shack: most surfaces are overlay panels, not separate documents,
...
export type SurfaceGroup = "Caching" | "Community" | "Shack" | "Account";
...
export const SURFACE_GROUPS: SurfaceGroup[] = ["Caching", "Community", "Shack", "Account"];
