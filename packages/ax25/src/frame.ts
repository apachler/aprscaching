...
/**
 * frame.ts — AX.25 v2.2 frame codec for CONNECTED mode. Unlike the APRS UI-only path in
 * @aprscaching/aprs, this handles every frame type and the full control field (N(S)/N(R)/P-F), so the
