...
> Migration number pinned to **`0012`** (`docs/design/14`); the doc's earlier `0003` label was retrospective.
...
and `api_keys` from `docs/design/11` are free/recognition too); `peers` + `peer_metrics` drive corroborated
