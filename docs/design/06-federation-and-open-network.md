...
> reach / governance design, are documented in **`docs/design/15-federation-next.md`**. Kept for the original
...
**Resolved (see `docs/design/14-open-decisions.md`):** (1) **License decided** — AGPL-3.0-or-later for the
...
table + a federation migration; full spec in `docs/design/14`.
...
rotation / instance registry / observability — is specced in **`docs/design/15-federation-next.md`**. F4 (trust)
