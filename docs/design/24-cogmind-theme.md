...
(`docs/design/26` Stage 3) merges this with the retro terminal shell — **selecting Cogmind *is* the late-90s
...
**Owner:** OE8APR
**Reads with:** `.claude/rules/ui-ux.md`, `.claude/rules/css.md`, `docs/design/06-ui-ia-m1.md`, `docs/design/27`
...
workbench app surface (set alongside `[data-theme="cogmind"]`; theme = shell, one motion, `docs/design/24` §1a).
