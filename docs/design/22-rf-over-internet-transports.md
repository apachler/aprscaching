...
is `docs/design/decisions/0001-transport-vs-trust.md`; (6) the hybrid-topology sketch is §5A above; (7) the
...
5. **Add a `docs/design/decisions/` ADR** capturing the transport-vs-trust rule so the
