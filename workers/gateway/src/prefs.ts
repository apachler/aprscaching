...
// Themes are "modern"/"cogmind"; dark/light/auto are also accepted so stored prefs using them
// validate (the client's normalizeTheme folds anything non-cogmind → modern).
