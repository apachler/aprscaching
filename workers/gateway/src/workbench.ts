...
/**
 * Time-series for the workbench station graphs. Two windowed series — the weather
...
/**
 * Recent raw frames heard from a station — a workbench diagnostic. Reconstructs
