...
// The CBOR page envelope codec lives in @aprscaching/shared (both circuit ends use it); re-exported so
// the gateway's sync surface, consumer, and tests keep one import site.
import { encodeFedSyncPage } from "@aprscaching/shared";
export { encodeFedSyncPage, decodeFedSyncPage, type FedSyncPage } from "@aprscaching/shared";
